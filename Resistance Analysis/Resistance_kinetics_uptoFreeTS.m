function [T_TimeCourse_final,Cv_UPtoFreeTS_Timecourse_2]=Resistance_kinetics_uptoFreeTS(theta_cellular,theta_variation,Dose_info)
%used by@kinetics_dNTP to train the parameters in diffs of dNTP pool
%imbalance
theta = theta_cellular;
...
%             0.95754];
        ...
        k_d =  1.0345;
        TS_0 = 0.0186;
        theta_resistance_cell = num2cell(theta_variation);
        [V_max_54,K_m_54,G_0, k_cat,k08,k_95,k_59 ,k_09, k5,lag_DSB,alpha, V_HRR, K_HRR,  lag_tumor,E_max_damage, EC_50 ]  = theta_resistance_cell{:};
