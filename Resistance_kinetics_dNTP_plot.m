function [T,Cv]=Resistance_kinetics_dNTP_plot(theta_variation,Dose_info)
...
[T_TimeCourse_final,Cv_UPtoFreeTS_Timecourse_2]=Resistance_kinetics_uptoFreeTS(theta_variation,Dose_info); %time span
...
Cv = real(Cv);
    function dC=DifEq(t_ode,c)
        ...
        theta = [0.21351;32.50090;3.71407;73.34474;3.77027;0.30262;3.33454;1.35311;0.27614;35.66968;6.04530;0.07853];
       k1  =  theta(1);
        k2 = theta(2);
        k3 = theta(3);
        k4 = theta(4);
