...
Seed_Model_DisplayLabel_pool = ["weekly for 4 weeks(Colon 38)"
    "daily for 4 days(Colon 26)"
    ...
    "every other day for 6 times(sensitive LS174T)"
    "every other day for 6 times(resistant LS174T)"
    ];
...
UpstreamKinetics_col = append('uni_' , UpstreamKinetics_col);
AllModel_info =  [];
