...
Time_Anabolites_DSB  =  AllModel_info(Model_Index).UpstreamKinetics;
load(Time_Anabolites_DSB, 'T_sim_treated', 'Cv_anabolites_treated','Cv_DSB_treated','T_sim_control', 'Cv_anabolites_control','Cv_DSB_control' )
...
if ismember(Model_Index, [4,6,7])
    ...
    theta_effect = [894.485483768487;0.00487466061884317;0.199818575085044;0.233109135875833];
