...
addpath('.\DataSet_TGI')
rng(2)
%TSInhibition_TestedPara_set = ["G_0","cat","08",  "59","95","09","alpha"]; %Elements stand for the association, dissociation, degradation of TS-FdUMP complex
%the biosynthesis of dUMP.
%k5,lag_DSB
folderpath = "D:\pythonworkshop\matlab\PKPD_5FU\compartmental analysis\EstimationResult2021\BEST\Resistanc_AfterReestimation50";
...
ParaPopulation_size =100; %total number of parameters that are sampled out.
...
for i = 4:6
    ...
    ResistanceAnalysis(batch_num,Case_num ,count,Anabolites_flag, Anabolites_TestedPara,...
...
function ResistanceAnalysis(batch_num,Case_num ,count, Anabolites_flag, Anabolites_TestedPara,...
    TSInhibition_flag ,TSInhibition_TestedPara,...
    dNTP_flag,DSB_flag, ParaPopulation_size ) 
